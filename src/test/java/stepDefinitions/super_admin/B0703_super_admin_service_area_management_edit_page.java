...
public class B0703_super_admin_service_area_management_edit_page {
	...
	Logger logger = LogManager.getLogger(B0703_super_admin_service_area_management_edit_page.class);
	...
	@Given("Verify that super admin user is on users service area management edit page as expected page title is {string}")
	public void verify_that_super_admin_user_is_on_users_service_area_management_edit_page_as_expected_page_title_is(String string) {
