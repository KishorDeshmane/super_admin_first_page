...
#Feature: Validate admin customers page functionality
#
#
#	
  #@Smoke
  #Scenario:  Validate that elements are present from admin customers users page
  #Given Verify that admin user is on the users customers user page as expected page title "Shield" 
...
#	Then Verify that search user field place holder value should be "Search..." in admin customers page
...
#	Then Verify that actions options 3 dots should be able to mouse hover from the admin customers page
