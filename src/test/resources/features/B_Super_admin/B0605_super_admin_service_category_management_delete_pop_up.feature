...
Feature: Validate super admin service category management delete pop up functionality
 ...
 @Smoke
  Scenario:  Validate that elemets is present with super admin user in super admin service category management delete pop up
  Given Verify that super admin user is on users service category management delete pop up as expected page title is "Shield"
