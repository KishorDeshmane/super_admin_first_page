#@Super_admin_manage_roles_and_permissions_page
#Feature: Validate super admin all user action options manage roles and permissions functionality
 #
 #
 #@Smoke
  #Scenario:  Validate that elemets and operations with super admin user in Super admin manage roles and permission in all users action options page
 ...
 #
  #@Smoke
  #Scenario:  Validate that elemets and opertaion with super admin user in Super admin manage roles and permission in all users action options page
  ...
  #Then Verify that super_admin enter the first name as "Super" in create user page
  #Then Verify that super_admin enter the last name as  "Admin" in create user page
  #Then Verify that super_admin enter the email as "super.admin@iffort.com" in create user page
  #Then Verify that super_admin select the country code "UAE" in create user page
  #Then Verify that super_admin enter the mobile number as "987654332" in create user page
 ...
 #	#Search created user
  #When super_admin search the using mail "super.admin@iffort.com" and click on the manage roles and permission page as expected page title "Shield"
#	When user click on the manage roles and permission button from the super_admin dashboard all users actions options button
 ...
 #	Then Verify that user management container change user status user click box is selected in the super_admin dashboard all users actions options button
  ...
  #Then Verify that super_admin search button is able to search the user with "super.admin@iffort.com" name of user in all users page
#	Then Verify that super_admin should be able to delete the user from the all users page
  ...
  #Given Verify that super_admin user is on the users all users actions options manage roles and permission page
  #Add super admin here
  #Then Verify that super_admin enter the first name as "adminone" in create user page
  #Then Verify that super_admin enter the last name as  "userone" in create user page
  #Then Verify that super_admin enter the email as "adminone.userone@iffort.com" in create user page
  #Then Verify that super_admin select the country code "UAE" in create user page
  #Then Verify that super_admin enter the mobile number as "907604250" in create user page
  #Then Verify that super_admin enter date of birth as "10/10/1925" in the create user page
  #Then Verify that super_admin send the profile image as jpg in create user page
  #Then Verify that super_admin select the gender as male from the radio button in create user page
  #Then Verify that super_admin enter password as "Admin@1234" in the create user page
  ...
  #Then Verify that the super_admin submit the button should create a new user in the all users page
 #	#Search created user
  #When super_admin search the using mail "adminone.userone@iffort.com" and click on the manage roles and permission page as expected page title "Shield"
#	When user click on the manage roles and permission button from the super_admin dashboard all users actions options button
  #Then Verify that the user is on the manage roles and permission page in super_admin dashbaord all users actions options button
  #Then Verify that user page header manage roles and permission is displayed in super_admin dashboard all users actions options button
  #Then Verify that breadcrum should be displayed in the super_admin dashboard all usres actions options button
 ...
 #	Then Verify that user management container change user status user click box is selected in the super_admin dashboard all users actions options button
  ...
  #Delete created user
  #Then super_admin navigate back to the all user page from the manage roles and management page
  #Then Verify that super_admin search button is able to search the user with "adminone.userone@iffort.com" name of user in all users page
#	Then Verify that super_admin should be able to delete the user from the all users page
  #
  #
  #
  ...
  #Given Verify that super_admin user is on the users all users actions options manage roles and permission page
  #Add super admin here
  #Then Verify that super_admin enter the first name as "partners" in create user page
  #Then Verify that super_admin enter the last name as  "admin" in create user page
  #Then Verify that super_admin enter the email as "partners.admin@iffort.com" in create user page
  #Then Verify that super_admin select the country code "UAE" in create user page
  #Then Verify that super_admin enter the mobile number as "9876543200" in create user page
  #Then Verify that super_admin enter date of birth as "10/10/1925" in the create user page
  #Then Verify that super_admin send the profile image as jpg in create user page
  #Then Verify that super_admin select the gender as male from the radio button in create user page
  #Then Verify that super_admin enter password as "Admin@1234" in the create user page
  ...
  #Then Verify that the super_admin submit the button should create a new user in the all users page
 #	#Search created user
  #When super_admin search the using mail "partners.admin@iffort.com" and click on the manage roles and permission page as expected page title "Shield"
#	When user click on the manage roles and permission button from the super_admin dashboard all users actions options button
  #Then Verify that the user is on the manage roles and permission page in super_admin dashbaord all users actions options button
  #Then Verify that user page header manage roles and permission is displayed in super_admin dashboard all users actions options button
  #
 ...
 #	Then Verify that user management container change user status user click box is selected in the super_admin dashboard all users actions options button
  ...
  #Delete created user
  #Then super_admin navigate back to the all user page from the manage roles and management page
  #Then Verify that super_admin search button is able to search the user with "partners.admin@iffort.com" name of user in all users page
#	Then Verify that super_admin should be able to delete the user from the all users page
  #
  #
  #
  ...
  #Given Verify that super_admin user is on the users all users actions options manage roles and permission page
  #Add super admin here
  #Then Verify that super_admin enter the first name as "partner" in create user page
  #Then Verify that super_admin enter the last name as  "executive" in create user page
  #Then Verify that super_admin enter the email as "partners.executive@iffort.com" in create user page
  #Then Verify that super_admin select the country code "UAE" in create user page
  #Then Verify that super_admin enter the mobile number as "9876541211" in create user page
  #Then Verify that super_admin enter date of birth as "10/10/1925" in the create user page
  #Then Verify that super_admin send the profile image as jpg in create user page
  #Then Verify that super_admin select the gender as male from the radio button in create user page
  #Then Verify that super_admin enter password as "Admin@1234" in the create user page
  ...
  #Then Verify that the super_admin submit the button should create a new user in the all users page
 #	#Search created user
  #When super_admin search the using mail "partners.executive@iffort.com" and click on the manage roles and permission page as expected page title "Shield"
#	When user click on the manage roles and permission button from the super_admin dashboard all users actions options button
  #Then Verify that the user is on the manage roles and permission page in super_admin dashbaord all users actions options button
  #Then Verify that user page header manage roles and permission is displayed in super_admin dashboard all users actions options button
  #
 ...
 #	Then Verify that user management container change user status user click box is selected in the super_admin dashboard all users actions options button
  ...
  #Delete created user
  #Then super_admin navigate back to the all user page from the manage roles and management page
  #Then Verify that super_admin search button is able to search the user with "partners.executive@iffort.com" name of user in all users page
#	Then Verify that super_admin should be able to delete the user from the all users page
  #
#
#
...
#
  ...
  #Given Verify that super_admin user is on the users all users actions options manage roles and permission page
  #Add super admin here
  #Then Verify that super_admin enter the first name as "technician" in create user page
  #Then Verify that super_admin enter the last name as  "user" in create user page
  #Then Verify that super_admin enter the email as "technician.user@iffort.com" in create user page
  #Then Verify that super_admin select the country code "UAE" in create user page
  #Then Verify that super_admin enter the mobile number as "9876541111" in create user page
  #Then Verify that super_admin enter date of birth as "10/10/1925" in the create user page
  #Then Verify that super_admin send the profile image as jpg in create user page
  #Then Verify that super_admin select the gender as male from the radio button in create user page
  #Then Verify that super_admin enter password as "Admin@1234" in the create user page
  ...
  #Then Verify that the super_admin submit the button should create a new user in the all users page
 #	#Search created user
  #When super_admin search the using mail "technician.user@iffort.com" and click on the manage roles and permission page as expected page title "Shield"
#	When user click on the manage roles and permission button from the super_admin dashboard all users actions options button
  #Then Verify that the user is on the manage roles and permission page in super_admin dashbaord all users actions options button
  #Then Verify that user page header manage roles and permission is displayed in super_admin dashboard all users actions options button
  #
 ...
 #	Then Verify that user management container change user status user click box is selected in the super_admin dashboard all users actions options button
  ...
  #Delete created user
  #Then super_admin navigate back to the all user page from the manage roles and management page
  #Then Verify that super_admin search button is able to search the user with "technician.user@iffort.com" name of user in all users page
#	Then Verify that super_admin should be able to delete the user from the all users page
#
#
#
...
#
  ...
  #Given Verify that super_admin user is on the users all users actions options manage roles and permission page
  #Add super admin here
  #Then Verify that super_admin enter the first name as "customer" in create user page
  #Then Verify that super_admin enter the last name as  "users" in create user page
  #Then Verify that super_admin enter the email as "customer.users@iffort.com" in create user page
  #Then Verify that super_admin select the country code "UAE" in create user page
  #Then Verify that super_admin enter the mobile number as "9876111111" in create user page
  #Then Verify that super_admin enter date of birth as "10/10/1920" in the create user page
  #Then Verify that super_admin send the profile image as jpg in create user page
  #Then Verify that super_admin select the gender as male from the radio button in create user page
  #Then Verify that super_admin enter password as "Admin@1234" in the create user page
  #Then Verify that super_admin enter comfirmed password as same as "Admin@1234" in the create user page
  ...
  #Then Verify that the super_admin submit the button should create a new user in the all users page
 #	#Search created user
  #When super_admin search the using mail "customer.users@iffort.com" and click on the manage roles and permission page as expected page title "Shield"
#	When user click on the manage roles and permission button from the super_admin dashboard all users actions options button
  #Then Verify that the user is on the manage roles and permission page in super_admin dashbaord all users actions options button
  #Then Verify that user page header manage roles and permission is displayed in super_admin dashboard all users actions options button
  #
 ...
 #	Then Verify that user management container change user status user click box is selected in the super_admin dashboard all users actions options button
  ...
  #Delete created user
  #Then super_admin navigate back to the all user page from the manage roles and management page
  #Then Verify that super_admin search button is able to search the user with "customer.users@iffort.com" name of user in all users page
#	Then Verify that super_admin should be able to delete the user from the all users page
  #
  #
  #
  ...
  #Given Verify that super_admin user is on the users all users actions options manage roles and permission page
  #Add super admin here
  #Then Verify that super_admin enter the first name as "guest" in create user page
  #Then Verify that super_admin enter the last name as  "user" in create user page
  #Then Verify that super_admin enter the email as "guest.user@iffort.com" in create user page
  #Then Verify that super_admin select the country code "UAE" in create user page
  #Then Verify that super_admin enter the mobile number as "9876111111" in create user page
  #Then Verify that super_admin enter date of birth as "10/10/1920" in the create user page
  #Then Verify that super_admin send the profile image as jpg in create user page
  ...
  #Then Verify that the super_admin submit the button should create a new user in the all users page
 #	#Search created user
  #When super_admin search the using mail "guest.user@iffort.com" and click on the manage roles and permission page as expected page title "Shield"
#	When user click on the manage roles and permission button from the super_admin dashboard all users actions options button
  #Then Verify that the user is on the manage roles and permission page in super_admin dashbaord all users actions options button
  #Then Verify that user page header manage roles and permission is displayed in super_admin dashboard all users actions options button
  #
...
#Dropdown position removed from here
 ...
 #	Then Verify that user management container change user status user click box is selected in the super_admin dashboard all users actions options button
  ...
  #Delete created user
  #Then super_admin navigate back to the all user page from the manage roles and management page
  #Then Verify that super_admin search button is able to search the user with "guest.user@iffort.com" name of user in all users page
#	Then Verify that super_admin should be able to delete the user from the all users page
  #
  #
  #
