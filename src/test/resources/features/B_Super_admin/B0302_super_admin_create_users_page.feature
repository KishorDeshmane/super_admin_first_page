...
Feature: Validate super admin all users create users page functionality
  ...
  @Regression
  Scenario: Validate that elements are present in all users create users page as super admin user
    ...
    Then Verify that first name users field placeholder value should be  "Enter your first name" in the super admin create users page
    ...
    Then Verify that last name users field placeholder value should be  "Enter your last name" in the super admin create users page
    ...
    Then Verify that email users field placeholder value should be  "Enter your email address" in the super admin create users page
    ...
    Then Verify that mobile number users field place holder value should be "Enter your mobile number" in the super admin create users page
    ...
    Then Verify that password userfield placeholder value should be "Enter your password" in the super admin create users page
    ...
    Then Verify that comfirm password userfield place holder value should be  "Confirm your password" in the super admin create users page
    ...
    Then Verify that assigned roles dropdown place holder value should be "Select roles" in the super admin create users page
